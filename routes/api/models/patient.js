...
const patientSchema = new Schema({
    ...
    'income level':{type:String,required: true},
    'income source':{type:String,required: true},
    'financial services needed':{type:[String],required: true},
    'financial assistance explanation':{type:String,required: true},
